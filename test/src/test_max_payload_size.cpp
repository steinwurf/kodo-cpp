...
void test_max_payload_size_encoder(uint32_t max_symbols,
...
void test_max_payload_size_decoder(uint32_t max_symbols,
                                  uint32_t max_symbol_size,
                                  kodocpp::code_type code_type,
                                  kodocpp::finite_field finite_field,
                                  bool trace_enabled)
...
TEST(TestMaxPayloadSize, invoke_api)
{
    ...
    // Testing ecoders
    // Full RLNC encoders
    test_max_payload_size_encoder(max_symbols, max_symbol_size,
    ...
    // Testing decoders
    // Full RLNC decoders
    test_max_payload_size_decoder(max_symbols, max_symbol_size,
                                   kodocpp::code_type::full_rlnc,
                                   kodocpp::finite_field::binary,
                                   false);
